...
final public class Matrix {
    ...
    public static double[][] matrix_inversion(double[][] matrix){
        ...
        for(int i=0; i<eigenvalues.length; i++){
            eigenvalues[i] = 1.0 / Math.sqrt(eigenvalues[i]);
            
        }

        double[][] diagonal = new Matrix(eigenvalues).getArray();

        return MatrixFunctions.multiply(MatrixFunctions.multiply(B,diagonal),B);
